...
if (isset($_GET["c"])) {
    ...
    $brands_rs = Database::search("SELECT * FROM `brand` WHERE `categories_id`='" . $category_id . "'");
...
?>
            ...
            <option value="<?php echo ($brands_data["id"]); ?>"><?php echo ($brands_data["brand_name"]); ?></option>
