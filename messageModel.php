                                                            ...
                                                            <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                                <a href="#" class="list-group-item list-group-item-action text-white rounded-0 bg-primary">
                                                                    <div class="media">
                                                                        ...
                                                                        ?>
                                                                            <img src="<?php echo ($img_data["path"]); ?>" width="50px" height="50px" class="rounded-circle">
                                                                        <?php
                                                                        } else {
                                                                        ?>
                                                                            <img src="resources/new_user.svg" width="50px" height="50px" class="rounded-circle">
                                                                        <?php
                                                                        }
                                                                        ...
                                                                        <div class="me-4">
                                                                            <div class="d-flex align-items-center justify-content-between mb-1 ">
                                                                                <h6 class="mb-0 fw-bold"><?php echo ($user_data["first_name"] . " " . $user_data["last_name"]); ?></h6>
                                                        ...
                                                        <div class="list-group rounded-0 " onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-black rounded-0 bg-secondary">
                                                                <div class="media">
                                                                    ...
                                                                    ?>
                                                                        <img src="<?php echo ($img_data2["path"]); ?>" width="50px" height="50px" class="rounded-circle">
                                                                    <?php
                                                                    } else {
                                                                    ?>
                                                                        <img src="resources/new_user.svg" width="50px" height="50px" class="rounded-circle">
                            ...
                            <div class="col-12 px-2">
                                <div class="row">
                                    <div class="input-group mb-3">
                                        ...
                                        <button class="btn btn-light fs-5" id="send_btn" onclick="send_msg();"><i class="bi bi-send-fill fs-5"></i></button>
                                    </div>
                                </div>
                            </div>
                            <!-- txt -->
