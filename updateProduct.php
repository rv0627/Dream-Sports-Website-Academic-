...
<head>
    ...
    <title>Update Product | Dream Sports</title>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <select class="form-select text-center" disabled>
                                                    ...
                                                    $category_rs = Database::search("SELECT * FROM `categories` WHERE `id`='" . $product["categories_id"] . "'");
                                                    $category_data = $category_rs->fetch_assoc();

                                                    ?>

                                                    <option><?php echo ($category_data["categories_name"]); ?></option>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="offset-lg-3 col-12 col-lg-6">
                                                ...
                                                $images_rs = Database::search("SELECT * FROM `product_image` WHERE `product_id`='" . $product["id"] . "'");
                                                $images_num = $images_rs->num_rows;

                                                for ($x = 0; $x < $images_num; $x++) {
                                                    $images_data = $images_rs->fetch_assoc();
                                                    $img[$x] = $images_data["image_path"];
                                                }
