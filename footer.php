        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start ">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase mt-4 text-warning">Dream Sports</h5>
                    <p>Here we are the Dream Sports.lk&trade; to support you for accomplish your desire by selling high quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <p>Copyright &copy; 2022 Dream Sports All Rights Reserved</p>
                </div>
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-at"></i> dreamsports@gmail.com</p>
